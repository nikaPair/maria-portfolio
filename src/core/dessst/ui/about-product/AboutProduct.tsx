...
export default function AboutProduct() {
    ...
    return (
        <section className={styles.section}>
            <Image src="/images/dessst.svg" alt="Dessst logo" width={129} height={24} className={styles.logo} />

            <div className={styles.infoGrid}>
                <div className={styles.infoCol}>
                    <span className={styles.infoLabel}>{t("site")}</span>
                    <a href="https://dessst.ru" target="_blank" rel="noopener noreferrer" className={styles.infoLink}>
                        dessst.ru
                    </a>
                </div>
                <div className={styles.infoCol}>
            ...
            <div className={styles.imageBlock}>
                <Image src="/images/dest/image 285.png" alt="Dessst screen" width={800} height={450} className={styles.mainImage} />
